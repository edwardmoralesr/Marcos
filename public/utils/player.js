...
class Player extends Phaser.Scene {
  ...
  gameOverPlayer(page) {
    ...
    switch (page.scene.key) {
      case "Sleeper":
        ...
        if (page.playerF) page.playerF.setVisible(false);
        if (page.playerB) page.playerB.setVisible(false);
        if (page.playerR) page.playerR.setVisible(false);
        if (page.playerRL) page.playerL.setVisible(false);
        break;
      case "Goal":
        break;
      default:
  ...
  runPlayerRight(more, x1, y1, x2, y2, x3, y3, time) {
    ...
    more.anims.create({
      ...
      frames: [{ key: "player0r" }, { key: "player1r" }, { key: "player2r" }],
      frameRate: 5,
  ...
  runPlayerFront(more, x1, y1, x2, y2, x3, y3, time) {
    ...
    more.anims.create({
      ...
      frames: [{ key: "player0f" }, { key: "player1f" }, { key: "player2f" }],
      frameRate: 5,
      repeat: -1, // -1 loop eterno
    });
  ...
  runPlayerLeft(more, x1, y1, x2, y2, x3, y3, time) {
    ...
    more.anims.create({
      ...
      frames: [{ key: "player0l" }, { key: "player1l" }, { key: "player2l" }],
      frameRate: 5,
      repeat: -1, // -1 loop eterno
    });
  ...
  runPlayerBack(more, x1, y1, x2, y2, x3, y3, time) {
    ...
    more.anims.create({
      ...
      frames: [{ key: "player0b" }, { key: "player1b" }, { key: "player2b" }],
      frameRate: 5,
      repeat: -1, // -1 loop eterno
    });
