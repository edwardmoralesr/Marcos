...
class Modal extends Phaser.Scene {
    ...
    getWorldModal(now){
        return new Promise((resolve, reject) => {
            ...
            pScene.modalText = pScene.add.text(modalX + modalWidth / 2, (modalY + modalHeight / 2) * 0.9, pScene.infoModal.msj, { fontStyle: 'bolder', fontSize: '26.7px', fill: ENV.FONT_COLOR }).setOrigin(0.5);

            pScene.confirmModalButton = pScene.add.image((modalX + modalWidth / 2) - (modalX * 0.85), modalY + modalHeight * 0.64, 'sleeper')
                .setScale(0.22)
                .setOrigin(0.5)
                .setInteractive()
                .on('pointerdown', () => {
            ...
            pScene.closeModalButton = pScene.add.image((modalX + modalWidth / 2) + (modalX * 0.85), modalY + modalHeight * 0.64, 'couple')
                .setScale(0.22)
                .setOrigin(0.5)
                .setInteractive()
                .on('pointerdown', () => {
            ...
            pScene.backModalButton = pScene.add.text((modalX + modalWidth / 2) + (modalX * 1.6), modalY + modalHeight * 0.33, pScene.infoModal.back, { fontStyle: 'bolder', fontSize: '27px', fill: ENV.FONT_COLOR })
                .setOrigin(0.5)
                .setInteractive()
                .on('pointerdown', () => {
                    pScene.modalBackground.setVisible(false);
